...
export default function GraduateJobDetailPage() {
    ...
    return (
      <div className="min-h-screen bg-background-light dark:bg-background-dark flex items-center justify-center px-4">
        <div className="max-w-md w-full text-center">
          ...
          <Link href="/dashboard/graduate/jobs" className="px-6 py-2 bg-primary text-white rounded-lg hover:bg-primary/90 transition-colors inline-block">
            Back to Jobs
          </Link>
        </div>
      </div>
    ...
    <div className="min-h-screen bg-background-light dark:bg-background-dark">
      <div className="max-w-[1200px] mx-auto px-4 md:px-10 py-10">
        <nav className="mb-6 text-sm text-gray-600 dark:text-gray-400">
          <Link href="/dashboard/graduate" className="hover:text-primary">Dashboard</Link>
          <span className="mx-2">/</span>
          <Link href="/dashboard/graduate/jobs" className="hover:text-primary">Jobs</Link>
          <span className="mx-2">/</span>
          ...
          <div className="lg:col-span-1">
            <div className="bg-white dark:bg-background-dark rounded-xl p-6 border border-gray-200 dark:border-white/10 sticky top-24">
              ...
              <div className="mt-6">
                {!showApplyForm ? (
                  <Link
                    href={`/dashboard/graduate/jobs/${jobId}?apply=true`}
