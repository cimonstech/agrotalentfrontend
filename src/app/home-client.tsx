...
export default function HomePageClient(props: HomePageClientProps) {
  ...
  return (
    <main className="max-w-[1200px] mx-auto overflow-x-hidden">
      ...
      {/* Rest of the component remains the same - I'll copy from the original */}
      {/* Stats Section */}
      <motion.section 
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          {loadingJobs ? (
            ...
            <div className="col-span-2 text-center py-12">
              <p className="text-gray-600 dark:text-gray-400">No jobs available at the moment. Check back soon!</p>
            </div>
          ) : (
