...
export const metadata = {
  title: 'For Students | AgroTalent Hub',
  description: 'Find internships and NSS placements with verified farms across Ghana. Gain practical experience and start your agricultural career.',
}
